  ...
  return (
    ...
    >
      ...
      <div className="container relative mx-auto flex flex-col items-center gap-8 px-4 text-center">
        ...
        <h1
          className={`lgtext-4xl min-h-[130px] max-w-[900px] font-manrope text-[30px] font-bold text-secondary md:min-h-[200px] md:text-[60px] lg:min-h-[200px] ${fadeUpClass(showHeading)}`}
        >
          Одна система для:
